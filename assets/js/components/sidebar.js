...
const icons = {
  ...
  support: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>`
};
...
export function renderSidebar(container, state, navigateCallback) {
  ...
  header.innerHTML = `
    ...
    <span>PixelOnWP</span>
    <span class="pp-sidebar-brand-badge">v1.0.3</span>
  `;
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'support', label: 'Support Center', icon: icons.support },
